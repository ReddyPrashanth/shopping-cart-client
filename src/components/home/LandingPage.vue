<template>
    <div class="bg-gray-200 px-16 flex items-center justify-around">
        <div class="my-16 w-1/3 text-center">
            ...
            <a href="#" class="bg-gray-200 p-1 sm:py-2 sm:px-4 rounded sm:font-semibold border-black border-2 hover:bg-gray-900 hover:text-white">Shop</a>
        </div>
        <div class="my-16">
